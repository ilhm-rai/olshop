                        ...
                        ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="<?= base_url('category/delete/' . $c->id); ?>" class="btn btn-sm btn-danger mr-1" role="button" title="Hapus"><span class="fa fa-trash-alt"></span></a>
                                    <a href="<?= base_url('category/edit/' . $c->id); ?>" class="btn btn-sm btn-primary" role="button" title="Ubah"><span class="fa fa-pencil-alt"></span></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
